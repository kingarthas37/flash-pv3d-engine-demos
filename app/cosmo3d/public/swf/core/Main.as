package core
{
	...
	public class Main extends Sprite
	{
		...
		private function loadVars():void {
			...
			swfWidth = vars["width"]!=null ? vars["width"] : 760;
			swfHeight = vars["height"]!=null ? vars["height"] : 280;
			dataURL = vars["dataurl"]!=null ? vars["dataurl"] : "datas/load_json.txt";
		...
		private function loadDatas():void
		{
			...
			var dataURL:URLRequest = new URLRequest(dataURL);
		...
		private function imageLoading(event:ProgressEvent):void
		{
			...
			textInfo.text= "加载库片图(" + (imageCount+1) + "/"+ _data.length + ")...";
			textInfo.setTextFormat(format);
	  ...
	  private function onTimerStartHandler(event:TimerEvent):void {
		  ...
		  var main3d:Main3d = new Main3d(this,swfWidth,swfHeight,_param,_data,images,imagesHover,imagesRe);  
